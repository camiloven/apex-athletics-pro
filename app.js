...
function renderConfig() {
    ...
    const groqOK = localStorage.getItem('groqKey');
    const geminiOK = localStorage.getItem('geminiKey');
    const sportsOK = localStorage.getItem('sportsKey');
    const fdOK = localStorage.getItem('fdOrgKey');
    const si = (k) => k ? '✅' : '❌';
